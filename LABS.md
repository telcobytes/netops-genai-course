...
| 2 · The No-Code Ceiling | `module02-nocode/` | *no code, no key, by design* — NotebookLM in a browser tab: the repo's change bundle, then 3GPP TS 38.331 itself. [Lab brief](module02-nocode/README.md) |
